...
const legendPanel = { // the color legend panel
    x: 150,
    y: config.margin.top,
    height: 50,
...
function renderTopTreePanel(tree){
...
function renderLeftTreePanel(tree){
