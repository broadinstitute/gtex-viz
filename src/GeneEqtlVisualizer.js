 ...
 * @param tissueTable {Dictionary} of tissue objects indexed by tissueSiteDetailId
 * @param urls {Dictionary} of the GTEx web service URLs from getGtexUrls(), must have the attribute dyneqtl
 * @returns {BubbleMap}
 */
function renderBubbleMap(par, gene, tissues, exons, urls){
