...
class BubbleMap {
    ...
    draw(dom, dimensions={w:1000, h:600}, ylabelAngle=30, yLabelPosAdjust=null, colorDomain=undefined){
    ...
    _setColorScale(domain){
        ...
        this.colorScale = setColorScale(data, this.colorScheme, true);
    }
...
function renderBubbleMap(par){
    ...
    bmap.draw(svg, {w:inWidth, h:inHeight}, par.columnLabelAngle, par.columnLabelPosAdjust, par.colorDomain);
    return bmap;
}
