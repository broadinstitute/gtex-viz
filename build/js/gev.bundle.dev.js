        ...
        .then(function(data){
            ...
            json(urls.singleTissueEqtl + gene.gencodeId)
                .then(function(data2){
                    ...
                    .then(function(data) {
                        let ld = parseLD(data);
                        svgPar.ldData = ld.filter((d)=>d.value>=svgPar.ldCutoff);
