...
function drawColorLegend(title, dom, scale, config, useLog, base=10, cell={h:15, w:50}){
    ...
    const data = scale.ticks(5).slice(1);
    // legend title
    dom.append("text")
