...
function _genereateRandomData(N=5){
    ...
    const data =  sequence(0, N).map((d) => {
        ...
        return {
            label: `dataset ` + d,
            values: sequence(0, 100).map(normal(mu, sigma))
        }
    });
    return data;
}
